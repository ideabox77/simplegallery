...
public class GalleryIntents {
    ...
    public static final String EXTRA_IMAGE_ORIENTATION = "timersassignment.simplegallery.orientation";
    public static final String EXTRA_IMAGE_TITLE = "timersassignment.simplegallery.title";
}
